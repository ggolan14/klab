...
const {DotsMindGameBenchmarkVersions, DotsMindGameBenchmarkUsersRecords} = require('./all_models/DotsMindGameBenchmark');
...
const AllModels = {
    ...
    DotsMindGameBenchmark: {
        versions: DotsMindGameBenchmarkVersions,
        records: DotsMindGameBenchmarkUsersRecords,
        tables: ['game', 'payment', 'summary', 'KeyTable'],
    },
    DotsMindGame: {
