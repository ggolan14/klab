  ...
  constructor(props) {
    ...
    if(this.props.gameCondition == "Repeated"){
     message_1 =  (
      <span>
        ...
        <br></br>In the first part, you will play the trivia-game and can win a bonus based on your performance.
        ...
        If you leave or stop responding before completing the two parts, you will not receive compensation.<br/>
      </span>
    );
  }else{
    message_1 =  (
    ...
    const message_2 = (
      <span>
        ...
        <br></br>After the question is presented and you decide on your answer,<br/>the correct answer will be revealed and you will be asked to report whether it matches the one you had in mind.
        <br></br> If the correct answer <strong>is</strong> the one you had in mind, you will receive a <strong>{formatPrice(1,this.props.signOfReward)} bonus.</strong> 
        <br></br> If the correct answer <strong>is not</strong> the one you had in mind, you <strong>will not receive</strong> a bonus.
      </span>
    );
    const message_3 = (
      <span>
  ...
  render() {
    ...
    return (
      <div className="trivia-container">
        ...
        <p><br></br><br></br>{messages[currentIndex]}</p>
