    ...
    <div className="dice-roll-container">
      {step === 1 && (
        <div className="centered-text">
          <p>This is a practice round. Think of a number between 1 and 6 and keep it in your mind.</p>
      ...
      {step === 2 && (
        <div className="centered-text">
          {!rolling && !showResult && (
            <div>
              <button onClick={rollDice}>Roll the dice2</button>
            </div>
          )}
          {rolling && (
