...
const Summary = ({ SummaryArgs }) => {
  ...
  return (
    <label>
      ...
      To receive your payment, please <b>copy the completion code</b> below and <b>click on the "Finish Game" button.</b><br/>It is essential to click on the <b>"Finish Game"</b> button for your data to be recorded!
    </label>
  );
};
