  ...
  render() {
    ...
    return (
      <div className="introduction">
        ...
        {currentIndex === 1 && <h2>Welcome to the Mind game!</h2>}
        ...
        {/* Show "Start MindGame" button if the last message */}
        {currentIndex === messages.length - 1 && (
